...
Ans: AI Copilot has access to current Kestra plugin documentation.


Q2. The non-RAG response about Kestra 1.1 features is best described as?

Ans: Vague, generic, or fabricated — the model guesses from training data.


Q3. What is the approximate output token count for multilingual_agent when running with summary_length = short?

Ans: 60 - 100 tokens (Execuation id: 3tfZOPuONP0rUNAQaEhhAX )
...
Ans: 2-5x more, 215/74=2.90 (Execuation id: 1TCixHyIOMpM4QORz9ok3P)
...
Ans: 2-4x more,  94/40=2.35 (Execuation id: 6n1Y9Lxc7lhWpZlfLIIExq)
...
Ans: Use traditional task-based workflows for predictability and auditability